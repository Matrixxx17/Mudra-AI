...
export default function ResultScreen() {
  ...
  // Convert params to numbers (they come as strings from URL)
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        <TouchableOpacity
          ...
          onPress={() => {
            // Use router.replace instead of navigation.replace
            router.replace({
              pathname: "/(tabs)_backup/QuizScreen",
              params: { moduleId, setId: 1 }
            });
          }}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            // Use router.navigate instead of navigation.navigate
            router.push({
              pathname: "/screen/ModuleScreen",
              params: { moduleId }
            });
          }}
        >
