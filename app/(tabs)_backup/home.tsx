    ...
    <View style={styles.container}>
      ...
      <View style={styles.formPage}>
        ...
        <TouchableOpacity
          ...
          onPress={() => setSelectedOption("learn")}
        >
          <AntDesign name="book" size={28} color="white" style={styles.icon} />
          <Text style={styles.buttonText}>To Learn</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          onPress={() => setSelectedOption("communicate")}
        >
          <FontAwesome6 name="people-group" size={24} color="white" style={styles.icon} />
          <Text style={styles.buttonText}>To Communicate</Text>
        </TouchableOpacity>
